...
const Advertisement: React.FC<AdvertisementProps> = ({ className = '', position }) => {
  let adContent;
  ...
  switch (position) {
    case 'sidebar':
      adContent = (
        <div className={`bg-secondary/50 border border-border/60 rounded-xl overflow-hidden p-4 text-center ${className}`}>
    ...
    case 'inline':
      adContent = (
        <div className={`bg-secondary/50 border border-border/60 rounded-xl overflow-hidden p-4 text-center my-6 ${className}`}>
          <div className="text-xs text-muted-foreground uppercase mb-2">Advertisement</div>
    ...
    case 'banner':
      adContent = (
        <div className={`bg-secondary/50 border border-border/60 rounded-xl overflow-hidden p-4 text-center my-4 ${className}`}>
          <div className="text-xs text-muted-foreground uppercase mb-2">Advertisement</div>
